...
model = smp.PSPNet(encoder_name="resnet50", encoder_weights=None, in_channels=3, classes=1)  # 与训练时一致
model.load_state_dict(torch.load("seg_model/pspnet_water_meter.pth", map_location=device), strict=False)
