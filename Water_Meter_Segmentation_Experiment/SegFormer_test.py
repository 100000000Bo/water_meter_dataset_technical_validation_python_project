...
model.decode_head.classifier = nn.Conv2d(256, 1, kernel_size=(1, 1))  # 确保输出通道数与训练时一致
model.load_state_dict(torch.load("segformer_water_meter.pth", map_location=device), strict=False)
