...
model.classifier[4] = nn.Conv2d(256, 1, kernel_size=(1, 1))  # 二分类，输出通道改为1
...
# 保存模型
#torch.save(model.state_dict(), "deeplabv3_water_meter.pth")
#print("模型已保存为 deeplabv3_water_meter.pth")
