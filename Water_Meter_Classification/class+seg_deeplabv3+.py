...
# Custom dataset class using the same structure as the training set
...
def evaluate_model(model, dataloader, device):
    ...
    with torch.no_grad():
        for images, masks, filenames in tqdm(dataloader, desc="Evaluating"):
            ...
            # Optionally save predicted images or perform further processing
...
model.classifier[4] = nn.Conv2d(256, 1, kernel_size=(1, 1))  # Match output channels
